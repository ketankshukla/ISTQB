...
|   |-- mock_exams/
|
|-- ct-mat-course/                            Mobile Application Testing (CT-MAT v1.0)
|   |-- README.md
|   |-- STUDY_PLAN.md
|   |-- EXAM_STRATEGY.md
|   |-- GLOSSARY.md
|   |-- PROGRESS_TRACKER.md
|   |-- 01_introduction_to_mobile_testing/
|   |-- 02_mobile_platforms_and_architecture/
|   |-- 03_mobile_functional_testing/
|   |-- 04_mobile_non_functional_testing/
|   |-- 05_mobile_test_automation/
|   |-- 06_mobile_testing_tools_and_environment/
|   |-- case_studies/
|   |-- mock_exams/
|
|-- ct-tas-course/                            Test Automation Strategy (CT-TAS v1.0)
|   |-- README.md
|   |-- STUDY_PLAN.md
|   |-- EXAM_STRATEGY.md
|   |-- GLOSSARY.md
|   |-- PROGRESS_TRACKER.md
|   |-- 01_introduction_to_test_automation_strategy/
|   |-- 02_test_automation_planning_and_roi/
|   |-- 03_test_automation_architecture_and_design/
|   |-- 04_test_automation_implementation_and_deployment/
|   |-- 05_test_automation_maintenance_and_evolution/
