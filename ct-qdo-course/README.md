...
| Parameter | Value |
|-----------|-------|
| Certification | ISTQB Certified Tester Quality in DevOps (CT-QDO) |
...
|---------|-------|-------------|
| 1 | Introduction to DevOps and Quality | ~10% |
| 2 | CI/CD Pipeline Testing | ~20% |
| 3 | Shift-Left Testing Practices | ~20% |
| 4 | Monitoring, Observability, and Feedback | ~20% |
| 5 | Infrastructure and Environment Testing | ~15% |
| 6 | DevOps Quality Tools and Automation | ~15% |
...
- DevOps engineers with quality responsibilities
- Anyone preparing for the ISTQB CT-QDO exam
