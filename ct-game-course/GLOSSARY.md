...
- **Genre** — Game category (RPG, FPS, puzzle, etc.)
...
- **Playtesting** — Observing real players to gather feedback
...
- **SDK** — Software Development Kit provided by platform holder
- **Shaders** — Programs controlling visual rendering
...
- **Texture** — Image applied to 3D models
