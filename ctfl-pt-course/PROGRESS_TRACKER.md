...
- [x] Chapter 2 — Performance Test Types and Objectives
  - [x] README.md
  - [x] lessons.md
  - [x] exam_traps.md
  - [x] practice_questions.md (score: ___/20)
- [x] Chapter 3 — Performance Testing Process
  - [x] README.md
  - [x] lessons.md
  - [x] exam_traps.md
  - [x] practice_questions.md (score: ___/20)
- [x] Chapter 4 — Performance Test Design
  - [x] README.md
  - [x] lessons.md
  - [x] exam_traps.md
  - [x] practice_questions.md (score: ___/20)
- [x] Chapter 5 — Performance Test Execution and Monitoring
  - [x] README.md
  - [x] lessons.md
  - [x] exam_traps.md
  - [x] practice_questions.md (score: ___/20)
- [x] Chapter 6 — Performance Analysis and Reporting
  - [x] README.md
  - [x] lessons.md
  - [x] exam_traps.md
  - [x] practice_questions.md (score: ___/20)
