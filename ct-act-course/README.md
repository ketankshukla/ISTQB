...
| Parameter | Value |
|-----------|-------|
| **Certification** | ISTQB Certified Tester — Acceptance Testing |
...
|---------|-------|-------------|
| 1 | Introduction to Acceptance Testing | ~15% |
| 2 | Acceptance Testing in the Software Development Lifecycle | ~15% |
| 3 | Business Acceptance Testing (BAT) | ~20% |
| 4 | Contract Acceptance Testing (CAT) | ~15% |
| 5 | Regulation Acceptance Testing (RAT) | ~15% |
| 6 | Acceptance Testing Tools and Automation | ~20% |

**Root files:**
- `README.md` — This file
- `STUDY_PLAN.md` — Suggested learning schedule
- `EXAM_STRATEGY.md` — Tactics for maximizing exam score
...
- Product owners and stakeholders who sign off on acceptance
...
| Source | Questions |
|--------|-----------|
| Chapter practice questions | 120 (20 per chapter) |
| Case study questions | 15 |
| Mock exams | 120 (3 exams × 40 questions) |
| **Total** | **255+** |
...
- Acceptance testing fundamentals (objectives, scope, criteria)
- Acceptance testing in SDLC (agile, V-model, incremental)
- Business acceptance testing (user stories, acceptance criteria, UAT)
- Contract acceptance testing (SLAs, contractual criteria, supplier testing)
