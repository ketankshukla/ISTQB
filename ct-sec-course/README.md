...
| Parameter | Value |
|-----------|-------|
| **Certification** | ISTQB Certified Tester — Security Testing |
...
|---------|-------|-------------|
| 1 | Introduction to Security Testing | ~15% |
| 2 | Security Testing Concepts and Principles | ~15% |
| 3 | Threat Modeling and Risk Analysis | ~20% |
| 4 | Security Test Design and Techniques | ~20% |
| 5 | Security Test Execution and Evaluation | ~15% |
| 6 | Security Testing Tools and Automation | ~15% |
...
- Security testing fundamentals (confidentiality, integrity, availability)
...
- Security test design (penetration testing, fuzzing, static analysis)
- Authentication, authorization, session management testing
