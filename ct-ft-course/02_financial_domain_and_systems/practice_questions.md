...
A. Executing trades
B. Risk management and compliance monitoring
C. Settlement and clearing
...
A. ACH transfer
B. Wire transfer
C. Real-time payment (RTP/FedNow)
D. Check
...
A. Monthly reconciliation reports
B. Real-time order execution and market data
C. Year-end tax reporting
D. Employee payroll
...
A. Domestic ACH transfers
B. International payment messaging
C. Real-time cryptocurrency trading
...
A. Tracks customer social media activity
B. Records all financial transactions with debit/credit entries
C. Manages marketing campaigns
D. Controls building access
...
B. Settlement, clearing, and reconciliation
C. Market data analysis
D. Customer prospecting
...
A. Settles immediately at the spot rate
B. Obligates parties to exchange currency at a future date
C. Is a type of equity investment
D. Has no settlement date
...
A. Trade settles in 2 minutes
B. Trade settles 2 business days after the trade date
C. Trade settles in 2 weeks
D. Trade is canceled after 2 days
...
A. The Interest Engine
B. The Loan Management component
C. The Fee Engine
