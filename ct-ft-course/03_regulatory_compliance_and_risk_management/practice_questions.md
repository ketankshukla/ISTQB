...
C. Best execution of trades
D. Anti-money laundering monitoring
...
A. All customers
B. High-risk customers such as PEPs
C. Only corporate accounts
D. Only retail customers
...
A. Process payment card data
B. Handle stock trading
C. Manage insurance claims
D. Store medical records
...
A. Only liquidity ratios
B. Capital adequacy ratios, liquidity ratios, and leverage limits
C. Only employee training records
D. Only customer satisfaction scores
...
B. System behavior under extreme but plausible adverse conditions
...
A. Running the control 100 times and checking pass rate
B. Verifying that the control addresses the identified risk
C. Measuring system response time
D. Checking user interface colors
...
A. A borrower defaults on a loan
B. A bank cannot meet short-term obligations
C. Stock prices decline rapidly
D. A cyberattack breaches customer data
...
A. Take no action
B. Generate an alert because the aggregate exceeds $10,000
C. Generate an alert only for the second deposit
D. Close the account
...
A. Separating development and test environments
B. Ensuring no single person can both initiate and approve a financial transaction
C. Dividing departments by geography
D. Splitting database tables across servers
...
A. SOX Section 409
B. MiFID II Article 1
C. Basel III Pillar 3
D. PCI-DSS Requirement 11
...
B. SOX segregation of duties
C. GDPR data portability
D. MiFID II best execution
