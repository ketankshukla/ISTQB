...
**Bingo**
A game of chance where players match numbers on cards against numbers drawn at random.

**Blackjack**
A card game where players aim to have a hand value closer to 21 than the dealer without exceeding 21.
...
**Collusion**
Illegal cooperation between players or between a player and dealer to gain an unfair advantage.

**Compliance Testing**
Testing to verify that a gambling product meets the regulatory requirements of the jurisdictions in which it operates.
...
**Game of Chance**
A game where the outcome is determined predominantly by random factors rather than skill.
...
**Money Laundering**
The process of disguising the origins of illegally obtained money. Gambling operators must have AML procedures.
...
**Payline**
A line on a slot machine that determines winning combinations of symbols.

**Paytable**
A table showing the payouts for each winning combination in a gambling game.

**Player Protection**
Measures and systems designed to safeguard players from gambling-related harm, including self-exclusion, deposit limits, and reality checks.

**Poker**
A family of card games where players bet on the value of their hand according to the game's rules.

**Problem Gambling**
Gambling behavior that causes harm to the individual or their family. Also called compulsive or pathological gambling.
...
A hardware or software device that generates a sequence of numbers that lack any pattern, used to determine game outcomes.

**Reality Check**
A player protection feature that displays a periodic reminder of time spent and money won or lost during a gambling session.

**Regulatory Body**
A government or independent organization responsible for licensing and overseeing gambling operations within a jurisdiction.

**Reel Strip**
The ordered list of symbols on a slot machine reel.

**Responsible Gaming**
Policies and practices that ensure gambling is conducted in a fair, safe, and responsible manner, minimizing harm to vulnerable individuals.

**Return to Player (RTP)**
The percentage of all wagered money that a game will pay back to players over time. Calculated as (Total Payout / Total Wagered) x 100.
...
**Slot Machine**
A gambling machine with spinning reels displaying symbols; wins are determined by matching symbols on paylines.
...
**White Label**
A gambling platform provided by one company but branded and operated by another.

**Withdrawal Limit**
A restriction on the maximum amount a player can withdraw from their account in a given period.
