...
|----|---------|-------------|---------|
| GenAI-5.1.1 | 5.1 | Explain a roadmap for adoption of GenAI in testing | K2 |
| GenAI-5.1.2 | 5.1 | Identify stages and activities for GenAI adoption | K2 |
...
- `practice_questions.md` — 12 original ISTQB-style questions with answer rationales
