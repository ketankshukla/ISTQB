...
- [ ] Read `01_introduction_to_genai_for_testing/exam_traps.md`
- [ ] Complete `01_introduction_to_genai_for_testing/practice_questions.md`
- [ ] Score: ___ / 15
...
- [ ] Read `02_prompt_engineering_for_testing/exam_traps.md`
- [ ] Complete `02_prompt_engineering_for_testing/practice_questions.md`
- [ ] Score: ___ / 15
- [ ] Review all incorrect answers
...
- [ ] Read `03_managing_risks_of_genai/exam_traps.md`
- [ ] Complete `03_managing_risks_of_genai/practice_questions.md`
- [ ] Score: ___ / 15
- [ ] Review all incorrect answers
...
- [ ] Read `04_llm_powered_solutions/exam_traps.md`
- [ ] Complete `04_llm_powered_solutions/practice_questions.md`
- [ ] Score: ___ / 15
- [ ] Review all incorrect answers
...
- [ ] Read `05_deploying_and_integrating_genai/exam_traps.md`
- [ ] Complete `05_deploying_and_integrating_genai/practice_questions.md`
- [ ] Score: ___ / 15
- [ ] Review all incorrect answers
...
- [ ] Review Mock Exam 1 wrong answers
- [ ] Mock Exam 2 (timed, 60 min)
- [ ] Mock Exam 2 Score: ___ / 40 (___%)
- [ ] Review Mock Exam 2 wrong answers
- [ ] Mock Exam 3 (timed, 60 min)
...
- [ ] Review all `exam_traps.md` files one final time
- [ ] Book your exam
- [ ] Pass the exam!
...
|-------|--------------|-------|
| Chapter quizzes | 80%+ | Identify weak areas early |
| Case studies | Comfortable with all tasks | Integration matters |
| Mock Exam 1 | 70%+ | First exposure to full exam |
| Mock Exam 2 | 80%+ | Improving timing and recall |
| Mock Exam 3 | 85%+ | Exam-ready confidence |
| Real exam | 90%+ | Your target |
