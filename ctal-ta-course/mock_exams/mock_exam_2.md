...
A. Testing that a user can log in with a valid password
B. Testing the database schema for normalization
C. Testing API response times under load
D. Testing that the application compiles without errors
...
A. Leading the review meeting
B. Deciding whether to conduct the review and allocating resources
C. Recording all defects found during the review
D. Fixing all defects identified in the review
...
A. Manual testers
B. Automation engineers or developers
C. Business analysts
D. Project managers
...
B. Defect detection rate (defects per test hour)
C. Number of requirements documents
...
A. Load testing is faster than stress testing
B. Load testing validates at expected load; stress testing exceeds expected load
C. Load testing uses real users; stress testing uses simulated users
...
B. The elimination of all programming
C. Automatic generation of test data
D. The tool to write itself
...
A. Automatically delay the release
B. Assess risk and discuss with stakeholders
C. Lower the criteria to 90% without discussion
D. Declare testing failed
...
A. The author is not present at the inspection
B. Defending is counterproductive to finding defects
C. The moderator does all the talking
D. The scribe records the author's defense
...
A. ROI is always positive from day one
B. ROI may be negative in year 1 but positive in subsequent years
C. ROI cannot be calculated for automation
D. ROI is typically 500% in the first month
...
A. The build is stable enough for formal testing
B. All tests will pass
C. No defects exist in the build
D. The test environment is unnecessary
