...
C. Only systems that use neural networks
D. Only robots with physical bodies
...
A. The same as Artificial Intelligence
B. A subset of AI where systems learn from data without explicit programming
C. Only used for image recognition
...
B. AI techniques for understanding and generating human language
C. Only used for translation
...
B. Interpreting and understanding visual information from images and videos
C. Only facial recognition
D. Network security
...
A. Learning from large datasets automatically
B. Using explicit rules from human experts to solve domain-specific problems
C. Being a type of neural network
...
C. Reinforcement learning
D. Rule-based system without data
...
D. Neither requires labeled data
...
B. Software that follows predefined rules to automate repetitive tasks
C. A neural network for robotics
D. The same as autonomous robots
...
C. A system that can perform any intellectual task a human can
D. A spam filter
...
A. Machine learning uses more memory
B. In traditional programming, rules are explicitly coded; in ML, patterns are learned from data
C. Traditional programming is faster
...
B. Neural network architecture using attention mechanisms
...
A. All AI uses machine learning
B. All machine learning uses deep learning
C. All deep learning uses neural networks
D. All neural networks are expert systems
