...
| Parameter | Value |
|-----------|-------|
| **Certification** | ISTQB Certified Tester — Big Data Testing |
...
|---------|-------|-------------|
| 1 | Introduction to Big Data Testing | ~15% |
| 2 | Big Data Architecture and Components | ~15% |
| 3 | Data Quality Testing | ~20% |
| 4 | Functional Testing of Big Data Applications | ~20% |
| 5 | Performance and Scalability Testing for Big Data | ~15% |
| 6 | Big Data Testing Tools and Automation | ~15% |
...
- Big Data fundamentals (5 Vs, characteristics, ecosystem)
- Big Data architectures (Hadoop, Spark, data lakes, data warehouses)
- Data ingestion, storage, and processing layers
- Data quality dimensions (completeness, accuracy, consistency, timeliness, validity, uniqueness)
- Functional testing of ETL/ELT pipelines, MapReduce/Spark jobs, and reports
