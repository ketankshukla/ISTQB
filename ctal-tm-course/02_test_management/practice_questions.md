...
- Risk B: Report formatting issue (Likelihood: High, Impact: Low)

Which risk should receive MORE testing effort?
...
A. Testing is becoming less effective
B. The software quality may be decreasing
C. The testers are working slower
D. The test environment is unstable
...
B. Identifying and assessing potential failure modes
...
A. The defect has been fixed
B. The developer was unable to reproduce the reported issue
C. The tester made a mistake reporting it
D. The defect is not important enough to fix
...
- Risk B: Likelihood 2, Impact 5 = Priority 10
- Risk C: Likelihood 3, Impact 3 = Priority 9

The test manager has limited time and can fully address only two risks. Which combination should receive the MOST testing effort?
