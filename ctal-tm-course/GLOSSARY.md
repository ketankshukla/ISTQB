...
**Defect Density**
The number of defects identified in a work product divided by the size of that work product (e.g., defects per KLOC or per function point).
...
**Exit Criteria**
The set of conditions that must be met before testing can be considered complete for a specific test level or phase.
...
**Independent Testing**
Testing performed by an organization that is independent of the development organization. Provides objectivity but may reduce communication.

**Integrated Testing**
Testing performed within the development team. Provides early feedback but may lack objectivity.
...
The ratio of net profit to the investment cost, expressed as a percentage. Used to evaluate the value of test automation and tools.

**Risk**
A factor that could result in future negative consequences. In testing, risks are used to prioritize testing effort.
...
**Test Control**
The activity that compares actual test progress against the plan and takes corrective action when necessary.

**Test Effort Estimation**
The process of predicting the amount of test-related work needed for a project.

**Test Level**
A group of test activities that are organized and managed together. Examples: component testing, integration testing, system testing, acceptance testing.

**Test Monitoring**
The activity of tracking test progress against the test plan.

**Test Objective**
A reason or purpose for designing and executing a test. Examples: find defects, gain confidence, provide information for decision-making.

**Test Plan**
A document describing the scope, approach, resources, and schedule of intended test activities.

**Test Planning**
The activity of defining the test objectives and specifying the test activities required to meet those objectives.
...
**Top-Down Estimation**
An estimation technique where an overall estimate is made first and then allocated to individual components or tasks.
...
**Wideband Delphi**
An estimation technique where experts independently estimate, then discuss as a group, then re-estimate until consensus is reached.
