...
A. Replace the need for reviewers
B. Guide reviewers to look for common types of defects
C. Document the solutions to defects
D. Track the time spent in the review
...
A. Immediately design a solution to fix it
B. Log it as a defect and continue the review
C. Ignore it if it seems minor
D. Ask the author to justify it in detail
...
A. Inspections are led by the author
B. Inspections collect metrics and have a more formal process
C. Technical reviews are always longer
D. Technical reviews use checklists; inspections do not
...
A. Writing all documents to be reviewed
B. Ensuring testability is considered in requirements and design reviews
C. Fixing all defects found during reviews
D. Avoiding reviews because they delay the project
...
A. Managers lack technical knowledge
B. Their presence may create pressure that reduces honest defect reporting
C. Reviews are confidential
D. Managers are too busy
...
B. The document is complete and self-contained
C. The review meeting has been completed
D. Metrics have been collected
...
A. Large review meetings with many participants
B. Focus on identifying defects rather than solving them during the meeting
C. Solving every identified issue immediately
D. Skipping preparation to save time
...
A. 0.4 defects per page
B. 2.5 pages per defect
C. 12 defects per document
D. 0.25 defects per page
...
A. Find defects before dynamic testing when they are cheaper to fix
B. Eliminate the need for any dynamic testing
C. Require less skilled staff than testing
D. Are faster than writing test cases
